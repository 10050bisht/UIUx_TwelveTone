...
public class ExportCode_To_Generate_BillingReport { // Reuse the code here
	...
	// @Test
	private void exportClientDetailsToExcel(String xpath, String sheetName, String outputFileName,
			String statusColumnValue) throws InterruptedException, IOException {
