...
public class Billing_Reports {
	...
	private void paid_amounts() throws InterruptedException, IOException {
		...
		List<WebElement> paidRows = driver.findElements(By.xpath(
	...
	private void findFailedRowAndWriteToExcel() throws InterruptedException, IOException {
		...
		List<WebElement> failedRows = driver.findElements(
				By.xpath("//tr[.//div[contains(@style, 'background: rgb(231, 102, 102)') and text()='Failed']]"));

		// List<WebElement> failedRows =
		// driver.findElements(By.xpath("//tr[.//div[contains(@class, 'MuiStack-root')
		// and contains(@class, 'css-j7qwjs')]//span[contains(text(), 'Failed')]]"));
	...
	private void ScheduledClientRowsToExcel() throws InterruptedException, IOException {
		...
		// Locate all rows with "failed" status
		List<WebElement> scheduledRows = driver.findElements(
				By.xpath("//tr[.//div[contains(@style, 'background: rgb(130, 97, 244)') and text()='Scheduled']]"));
